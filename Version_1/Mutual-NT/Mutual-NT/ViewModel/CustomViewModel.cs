...
namespace Mutual_NT.ViewModel
{
    ...
    public sealed class CustomViewModel : ViewBase
    {
        ...
        public bool HasModifications(object entity, IDictionary<string, object> oldValues)
        {
            ...
            // This piece of code should be placed after the 'Insert' case.
        ...
        public void InsertEntity<T>(object entity, string entityName = null) where T : class
        {
            if (entity == null)
            {
                return;
            ...
            this.entityList.ProcessEntity<T>(entity, TrackableEntity.Operation.Insert, entityName);
        }
